...
export default function Footer() {
	...
	return (
		<footer className="footer pt-64 pb-16 bg-main-gradient overflow-hidden">
			<div className="container">
				<div className="footer-wrapper">
					<div className="footer-links mb-36 rounded-16 py-32" data-aos="fade-up">
					...
					<div className="footer-contact-wrapper mb-48" data-aos="fade-up">
						<div className="row justify-content-center">
							<div className="col-md-6 col-xl-5">
								<div className="locations-wrapper bg-light-bg rounded-8 p-16">
							...
							<div className="col-md-6 col-xl-5">
								<div className="contact-us-wrapper bg-light-bg rounded-8 p-16">
									<div className="footer-top mb-32">
					...
					<div className="footer-bottom-description general-content-box" data-aos="fade-up">
						<div className="ft-bottom-logo-wrapper mx-auto">
							<LogoWhite />
						</div>
						<p className="text-center mx-auto text-white">Built for PC enthusiasts in Nepal. Compare, customize, and create your perfect build with ease.</p>
						<p className="text-center mx-auto">
							Need help? Visit our <Link to="/contact-us">Contact Us</Link> page.
						</p>
					</div>
				</div>
			</div>

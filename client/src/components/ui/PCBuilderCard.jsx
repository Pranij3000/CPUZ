              ...
              <div className="row">
                <div className="col-12 col-md-6">
                  <div className="search-wrapper d-flex align-items-center">
                    <input type="text" className="p-8 rounded-8" value={searchTerm} onChange={handleInputChange} placeholder="Search components..." />
              ...
              <div key={index} className="col-12 col-md-6 col-xl-4">
                <div className="item-wrapper d-flex border-white-200 rounded-12 overflow-hidden">
                  ...
                  <div className="item-content-wrapper p-12 d-flex flex-column justify-content-between">
                    ...
                    <button className="text-white mt-8 border-white-200 py-4 px-16 d-block">Add +</button>
                  </div>
                </div>
              </div>
            ))}
